locals {
  meta = {
    ...
    service    = "grafana"
    env        = "production",
    repository = "755991664675.dkr.ecr.ap-northeast-2.amazonaws.com/infrastructure/grafana:9.2.6-20221130",
  }
  ...
  ecs_cluster_id = data.terraform_remote_state.production_ecs_monitoring.outputs.ecs_id
...
[
  {
    ...
    "environment": [
      ...
      {
        "name": "SERVER_DSN",
        "value": "https://monitoring.pickstudio.io:443"
      }
    ],
    "secrets": [
      {
        "name": "GITHUB_CLIENT_ID",
        "valueFrom": "arn:aws:ssm:ap-northeast-2:755991664675:parameter/ecs/${local.meta.env}/monitoring/grafana/GITHUB_CLIENT_ID"
      },
      {
        "name": "GITHUB_CLIENT_SECRET",
        "valueFrom": "arn:aws:ssm:ap-northeast-2:755991664675:parameter/ecs/${local.meta.env}/monitoring/grafana/GITHUB_CLIENT_SECRET"
      },
      {
        "name": "DATABASE_DSN",
        "valueFrom": "arn:aws:ssm:ap-northeast-2:755991664675:parameter/ecs/${local.meta.env}/monitoring/grafana/DATABASE_DSN"
      }
    ]
  }
]
